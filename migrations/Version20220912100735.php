 ...
 */
final class Version20220912100735 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE projects_languages (project_id INT NOT NULL, language_id INT NOT NULL, INDEX IDX_796D9446166D1F9C (project_id), INDEX IDX_796D944682F1BAF4 (language_id), PRIMARY KEY(project_id, language_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
